...
const ProductForm = (props) => {
  ...
  let [productData, setProductData] = useState({
    ...
    images: [
      ...
      { image: "https://via.placeholder.com/700x321.png" },
    ],
  });
  ...
  const handleCategoryChange = (e) => {
    let cloneNewCategory = { ...newCategory };
    cloneNewCategory[e.target.name] = e.target.value;
    setNewCategory(cloneNewCategory);
  };

  const handleBrandChange = (e) => {
    let cloneNewBrand = { ...newBrand };
    cloneNewBrand[e.target.name] = e.target.value;
    setNewBrand(cloneNewBrand);
  };
    ...
    <React.Fragment>
      ...
      {1 && (
        <div className="container">
          <form
            onSubmit={handleAddEditProductForm}
            className="mt-3 mx-auto col-9 col-sm-8 col-lg-6 col-xl-4"
          >
            ...
            <div className="mb-3">
              ...
              <div
                className="border rounded border-3 border-secondary my-3 p-3"
                style={categoryStyle}
              >
                <label htmlFor="inputNewCategoryName" className="form-label">
                  Category name
                </label>
                <input
                  name="name"
                ...
                />
                <label
                  htmlFor="inputNewCategoryDescription"
                ...
                <input
                  ...
                  type="text"
                  className="form-control"
                  id="inputNewCategoryDescription"
                />
              </div>
            </div>
            <div className="mb-3">
              ...
              <div
                ...
                style={brandStyle}
              >
                <label htmlFor="inputNewBrandName" className="form-label">
                  Brand name
                </label>
                <input
                  name="name"
                ...
                />
                <label
                  htmlFor="inputNewBrandDescription"
                  className="form-label"
                >
                  Brand description
                </label>
            ...
            <button type="submit" className="btn w-50 btn-primary mb-4">
              {id === "new" ? "Add" : "Edit"}
            </button>
          </form>
        </div>
