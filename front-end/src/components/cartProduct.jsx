        ...
        <div className="card shadow mb-3 ">
          <div className="card-body d-flex justify-content-between p-1 p-sm-3">
            <div className="d-flex">
              ...
              <div className="ms-3 text-start">
                ...
                <p className="small mb-0">
                  ...
                  from
                  <span className="mx-1">{this.props.product.brand.name}</span>
                </p>
              </div>
            </div>
            ...
            <div className="d-flex align-items-center">
              ...
              <p className="border border-secondary rounded px-3 mx-2 mt-4">
                {this.props.product.selectedQuantity}
              </p>
              <span
                role="button"
                onClick={() =>
            ...
            <div className="d-flex align-items-center">
              <i
                role="button"
                onClick={() =>
                  this.props.handleSelectProductToCart(this.props.product)
                }
                className="bi bi-trash3-fill fs-4 text-dark"
              ></i>
            </div>
          </div>
        </div>
